  ...
  return (
    <div>
        <div className="details grid grid-cols-1 sm:grid-cols-2 items-center justify-items-center">
            ...
            <div className="image mt-10 w-[80%] flex justify-center">
                <Image src={item.img} height={'400px'} width={'400px'} alt='' />
            </div>
        </div>
        <div className="buttons flex justify-center items-center">
          <button className='mt-10 inline-block shadow-lg bg-[#f91944] hover:bg-red-500 text-white font-bold rounded-full py-2 px-5' onClick={()=> openItem(false)}>
